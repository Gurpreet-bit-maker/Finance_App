...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-10 m-1 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form className="space-y-1" onSubmit={handleSubmit(submitForm)}>
          ...
          />
          {errors.userPhone ? (
            <p className="text-sm text-red-400">{errors.userPhone.message}</p>
          ) : (
            <p className=" h-5"></p>
          )}
          <input
          ...
          >
            {loader ? (
              <div className="flex justify-center items-center" role="status">
                ...
                <svg
                  aria-hidden="true"
                  className="w-6 h-6 text-neutral-tertiary animate-spin fill-brand fill-black"
                  viewBox="0 0 100 101"
                  fill="none"
